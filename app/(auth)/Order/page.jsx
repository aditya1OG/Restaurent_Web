...
import FoodCategories from '../FoodCategory/page';
import { foodCategories } from '@/utils/data';
import { dumplings } from '@/utils/data';
import { noodles } from '@/utils/data';
...
const page = () => {
    return (
        <div className='flex flex-col items-center justify-center w-full'>
            ...
            <div id='soupcategory' className='flex flex-col'>
                ...
                <div className="grid md:place-items-center  md:grid-cols-2 xl:grid-cols-3 mt-8 gap-12 text-center text-[12px] md:text-sm">
                    {foodCategories.map(category => (
                        <FoodCategories key={category.id} name={category.name} items={category.items} />
                    ))}
                </div>
            </div>
            <div id='dumplingscategory' className='flex flex-col gap-3 '>
            ...
            <div id='noodlescategory' className='flex flex-col gap-3 '>
